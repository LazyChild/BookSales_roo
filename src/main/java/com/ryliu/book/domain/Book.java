...
public class Book {
	...
	public static TypedQuery<Book> findBooksByPublisherLike(String publisher) {
	...
	public static TypedQuery<Book> findBooksByTitleLike(String title) {
	...
	public static Book fromJsonToBook(String json) {
        return new JSONDeserializer<Book>().use(null, Book.class).deserialize(json);
    }

	public static String toJsonArray(Collection<Book> collection) {
        return new JSONSerializer().exclude("*.class").serialize(collection);
    }

	public static Collection<Book> fromJsonArrayToBooks(String json) {
